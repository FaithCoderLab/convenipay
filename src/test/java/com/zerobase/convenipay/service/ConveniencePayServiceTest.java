...
class ConveniencePayServiceTest {
    ...
    void pay_success() {
        // given
        PayRequest payRequest = new PayRequest(ConvenienceType.GS25, 100, PayMethodType.MONEY);
    ...
    void pay_fail() {
        // given
        PayRequest payRequest = new PayRequest(ConvenienceType.GS25, 1_000_001, PayMethodType.MONEY);
    ...
    void pay_cancel_success() {
        // given
        PayCancelRequest payCancelRequest = new PayCancelRequest(ConvenienceType.GS25, 100, PayMethodType.MONEY);
    ...
    void pay_cancel_fail() {
        // given
        PayCancelRequest payCancelRequest = new PayCancelRequest(ConvenienceType.GS25, 1_000_001, PayMethodType.MONEY);
